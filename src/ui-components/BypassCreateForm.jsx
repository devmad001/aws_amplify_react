...
export default function BypassCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    setSite_id(initialValues.site_id);
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new Bypass(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "BypassCreateForm")}
      {...rest}
    >
      <TextField
        label="Site id"
